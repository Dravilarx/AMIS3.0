                ...
                <div className="p-8">
                    {!result ? (
                        <div className="space-y-6">
                            <div className="relative border-2 border-dashed border-white/10 rounded-2xl p-12 text-center group hover:border-blue-500/30 transition-all cursor-pointer">
                                <input
                                    type="file"
                                ...
                                />
                                <Upload className="w-12 h-12 text-white/10 mx-auto mb-4 group-hover:text-blue-500/50 transition-colors" />
                                <p className="text-sm font-bold text-white/60 mb-1">
                                    {file ? file.name : "Arrastra las bases de la licitación aquí"}
                                </p>
                                <p className="text-[10px] text-white/20 uppercase tracking-widest">Formatos soportados: PDF (Máx 20MB)</p>
                            </div>
                        ...
                        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="flex gap-3 mt-8">
                                <button
                                    ...
                                    className="flex-1 py-3 bg-white/5 text-white/60 rounded-xl font-bold uppercase tracking-widest text-[10px] hover:bg-white/10 transition-all"
                                >
                                    Reintentar
                                </button>
                                <button
                                    onClick={handleSave}
                                    className="flex-[2] py-3 bg-blue-600 text-white rounded-xl font-black uppercase tracking-widest text-[10px] hover:bg-blue-500 shadow-xl shadow-blue-600/20 transition-all border border-blue-400/30"
                                >
