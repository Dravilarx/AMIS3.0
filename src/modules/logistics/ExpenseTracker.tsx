        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-brand-text/40 text-sm">Control de gastos y reembolsos con Auditoría AI</p>
                </div>
                <div className="flex gap-2">
                    <button className="flex items-center gap-2 px-4 py-2 bg-brand-surface border border-brand-border rounded-lg hover:bg-brand-surface/80 transition-colors text-sm font-medium">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-brand-primary hover:bg-brand-primary/90 disabled:bg-brand-primary/50 text-white rounded-lg transition-all font-medium text-sm shadow-lg shadow-brand-primary/20"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="card-premium">
                    <p className="text-[10px] text-brand-text/40 uppercase font-bold tracking-widest mb-1">Total Verificado</p>
                    <p className="text-2xl font-black">{formatCurrency(totalConfirmed)}</p>
                </div>
                <div className="card-premium">
                    <p className="text-[10px] text-brand-text/40 uppercase font-bold tracking-widest mb-1">Pendiente Revisión</p>
            ...
            <div className="card-premium overflow-hidden !p-0">
                <table className="w-full text-left text-sm">
                    <thead>
                        <tr className="bg-brand-surface text-brand-text/40 border-b border-brand-border">
                    ...
                    <tbody className="divide-y divide-brand-border/50">
                        {expenses.map((expense) => (
                            <tr key={expense.id} className="hover:bg-brand-surface/50 transition-colors group">
                                <td className="px-6 py-4">
                                    <p className="font-bold text-brand-text/90">{expense.vendor}</p>
                                    <p className="text-[10px] text-brand-text/30 uppercase tracking-tighter">RUT: {expense.tax_id}</p>
                                </td>
                                <td className="px-6 py-4 text-brand-text/60 font-medium">
                                    {expense.date}
                                </td>
                                <td className="px-6 py-4">
                                    <span className="bg-brand-surface border border-brand-border px-2 py-0.5 rounded text-[10px] text-brand-text/80">
                                        {expense.category}
                                    </span>
                                </td>
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button className="p-2 text-brand-text/20 hover:text-danger transition-colors opacity-0 group-hover:opacity-100">
