            ...
            <div className="card-premium w-full max-w-2xl max-h-[90vh] overflow-y-auto relative animate-in fade-in zoom-in duration-300">
                ...
                <div className="flex items-center gap-1 p-1 bg-white/5 border border-white/10 rounded-xl mb-8">
                    ...
                    <button
                        ...
                        className={cn(
                            "flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-xs font-bold transition-all",
                            activeTab === 'induction' ? "bg-white text-black shadow-lg" : "text-white/40 hover:text-white/60 hover:bg-white/5"
                        )}
                    >
                            ...
                            <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-3">
                                        <div className={cn(
                                            ...
                                            formData.induction?.enabled ? "bg-blue-500/10 text-blue-400" : "bg-white/5 text-white/20"
                                        )}>
                                            <ShieldCheck className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h3 className="text-sm font-bold text-white/90">Gestión de Inducción</h3>
                                            <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Punto de Control Auditoría</p>
                                        </div>
                                    </div>
                                ...
                                {formData.induction?.enabled && (
                                    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-200">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                <label className="text-[10px] uppercase font-bold text-white/40 tracking-widest">Inicio Inducción</label>
                                                <input
                                                    type="date"
                                                    className="bg-neutral-900 border border-white/10 rounded-lg w-full px-4 py-2 text-sm focus:border-blue-500/50 outline-none"
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-[10px] uppercase font-bold text-white/40 tracking-widest">Fin Inducción</label>
                                                <input
                                                    type="date"
                                                    className="bg-neutral-900 border border-white/10 rounded-lg w-full px-4 py-2 text-sm focus:border-blue-500/50 outline-none"
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3 p-3 bg-blue-500/5 border border-blue-500/10 rounded-xl">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-xs font-bold text-blue-200">Verificación de Lectura y Aceptación</p>
                                                    <p className="text-[9px] text-blue-400/60 uppercase tracking-tighter">Legalmente vinculante para certificaciones</p>
                                                </div>
                                                <input
                                                    type="checkbox"
                                            ...
                                            <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-xl flex items-start gap-3">
                                                <BellRing className="w-5 h-5 text-amber-500 mt-0.5" />
                                                <div>
                                                    <p className="text-[10px] font-bold text-amber-200 uppercase tracking-widest">Sistema de Alertas</p>
                                ...
                                {!formData.induction?.enabled && (
                                    <div className="text-center py-8">
                                        <ShieldCheck className="w-12 h-12 text-white/5 mx-auto mb-2" />
                                        <p className="text-xs text-white/20">La inducción está desactivada para este perfil profesional.</p>
                                    </div>
                                )}
                            </div>
                        </div>
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        {doc?.isValidated && (
                                                            <div className="flex items-center gap-1 mt-1">
                                                                ...
                                                                <span className="text-[8px] font-bold text-blue-400 uppercase tracking-widest">Validado Agrawall AI</span>
                                                            </div>
                                                        )}
                                                        {doc?.expiryDate && (
                                                        ...
                                                        <div className="flex items-center gap-1">
                                                            ...
                                                            <button
                                                                ...
                                                                className={cn(
                                                                    ...
                                                                    doc.isLocked ? "text-white/10 cursor-not-allowed" : "text-white/20 hover:bg-red-500/10 hover:text-red-400"
                                                                )}
                                                            >
