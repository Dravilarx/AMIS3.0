...
export const ShiftManager: React.FC = () => {
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] card-premium bg-red-500/5 border-red-500/20">
                <AlertCircle className="w-12 h-12 text-red-500 mb-6" />
                <h3 className="text-xl font-black text-red-400 uppercase tracking-tight mb-2">Error de Sincronización</h3>
                <p className="text-white/40 text-[10px] font-mono uppercase tracking-widest max-w-md text-center mb-8">
                    {error}
                </p>
                <div className="flex gap-4">
                    <button
                        onClick={() => window.location.reload()}
                        className="px-6 py-2 bg-red-600 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-red-500 transition-all shadow-lg"
                    >
                        Reintentar Conexión
                    </button>
                    <button
                        onClick={() => setViewMode('list')}
                        className="px-6 py-2 bg-white/5 border border-white/10 text-white/60 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-white/10 transition-all"
                    >
                        Vista de Emergencia
                    </button>
                </div>
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <div className="bg-blue-500/10 border border-white/5 rounded-xl p-1 flex">
                        <button
                            onClick={() => setViewMode('list')}
                            className={cn(
                                "p-2 rounded-lg transition-all",
                                viewMode === 'list' ? "bg-blue-600 text-white shadow-lg" : "text-white/40 hover:text-white/60"
                            )}
                        >
                        ...
                        <button
                            ...
                            className={cn(
                                "p-2 rounded-lg transition-all",
                                viewMode === 'timeline' ? "bg-blue-600 text-white shadow-lg" : "text-white/40 hover:text-white/60"
                            )}
                        >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl text-xs font-black uppercase tracking-tighter hover:bg-blue-500 transition-all shadow-lg active:scale-95"
                    >
