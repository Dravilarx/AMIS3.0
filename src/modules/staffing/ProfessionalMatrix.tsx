        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-prevenort-text/40 text-sm">Gestión de competencias y logística del holding</p>
                </div>
                <div className="flex items-center gap-2">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="bg-prevenort-surface border border-prevenort-border rounded-lg pl-10 pr-4 py-2 text-sm text-prevenort-text focus:outline-none focus:border-info/50 w-64 transition-all"
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)}
                        />
                    </div>
                    <button className="p-2 bg-prevenort-surface border border-prevenort-border rounded-lg hover:bg-prevenort-primary/10 transition-colors">
                        <Filter className="w-4 h-4 text-prevenort-text/60" />
                    </button>
            ...
            <div className={cn(
                ...
                {filteredProfessionals.map((prof) => (
                    <div
                        ...
                        className={cn(
                            "card-premium group hover:border-info/30 transition-all duration-300 cursor-pointer",
                    ...
                    >
                        <div className={cn(
                            ...
                            <div className="flex items-start justify-between">
                                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-prevenort-surface to-prevenort-surface/50 border border-prevenort-border flex items-center justify-center text-xl font-bold text-prevenort-text">
                                    {prof.name[0]}
                                </div>
                            ...
                            <div className={viewMode === 'list' ? "flex flex-row items-center gap-8" : "space-y-4"}>
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <h4 className="font-bold text-lg text-prevenort-text group-hover:text-info transition-colors">
